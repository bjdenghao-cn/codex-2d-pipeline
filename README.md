...
**面向游戏广告前贴片与游戏宣传：你给创意，AI 组织制作，你确认效果。**

`2d-pipeline` 指导 Codex 把游戏广告制作步骤串起来：从完整故事、二维素材、动作与声音，到 Godot 编排和 MP4。它把可控环节拆开，便于精确安排前几秒钩子、玩法卖点、UI、奖励节点、动作顺序和结尾承接，并可单独替换受影响部分、复用素材制作测试版本。

它是工作流规则与脚本，不是独立生图软件，也不是“一句话保证出精品”。缺工具、素材或审批时会说明原因并暂停；可复用仍有效的成果，再继续受影响的步骤。
...
<img src="workflow-cover.png" width="600" alt="用 AI 制作游戏广告短片：2d-pipeline 小白使用指南">

[查看完整九图教程](TUTORIAL.md)
...
不同生图工具的登录、费用和接口不同；让 Codex 检查你的实际工具，不要把“有生图账号”当成“已接通自动调用”。详细部署见 [使用说明](USAGE.md)。
